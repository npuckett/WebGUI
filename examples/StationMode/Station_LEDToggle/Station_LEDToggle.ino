/*
  Station_LEDToggle.ino - WebGUI Library LED Toggle Example (Station Mode)
...
void setup() {
  ...
  Serial.begin(115200);
  Serial.println("Starting WebGUI Station_LEDToggle Example...");
  ...
  Serial.println();
  Serial.println("===============================================");
  Serial.println("WebGUI LED Toggle Example - Station Mode");
  Serial.println("===============================================");
  ...
  Serial.println("to access the LED control interface.");
  Serial.println("===============================================");
