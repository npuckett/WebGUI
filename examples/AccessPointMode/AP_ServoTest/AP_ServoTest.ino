...
const char* PAGE_TITLE = "3-Servo Test with Attach/Detach Toggle";  // Browser tab title and page headingSCRIPTION:
  ...
  2. Open Serial Monitor (115200 baud) to see connection info
  3. Connect your device to WiFi network "Arduino-ServoControl"
  4. Password: "servo123"
...
const char* AP_NAME = "Arduino-ServoControl";     // WiFi network name
...
void setup() {
  ...
  Serial.begin(115200);
  Serial.println("Starting WebGUI AP_ServoTest Example...");
  ...
  Serial.println();
  Serial.println("===============================================");
  Serial.println("WebGUI Servo Test - Access Point Mode");
  Serial.println("===============================================");
  Serial.println("WiFi Network: " + String(AP_NAME));
  ...
  Serial.println("===============================================");
  Serial.println("Ready! Connect to WiFi and open web interface.");
  Serial.println("===============================================");
  Serial.println();
}
